...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium asperiores beatae fuga?</p>
        <a href="" className="button button-flex" id="contact">
            Say Hello
            <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
