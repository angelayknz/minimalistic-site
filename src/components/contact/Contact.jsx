...
const Contact = () => {
    ...
    const sendEmail  = (e) => {
        e.preventDefault()
        emailjs.sendForm('service_76s1u1f', 'template_sa40ckf', form.current, 'yimrMpaTncbIgK_Q3')
      e.target.reset()
    }
  return (
        ...
        <div className="contact__container container grid">
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <button href="" className="button button-flex" id="contact">
                Send Message
                <svg
                  class="button__icon"
